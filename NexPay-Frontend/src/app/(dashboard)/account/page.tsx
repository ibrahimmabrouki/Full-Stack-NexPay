...
export default function AccountPage() {
  ...
  const handleToggle = async (
    key: "receive_enabled" | "send_enabled" | "deposit_enabled",
  ) => {
        ...
        <div className="space-y-6">
            ...
            {prefLoading || !preferences ? (
              ...
              <div className="space-y-4">
                  ...
                  >
                    <div
                      className={`w-4 h-4 bg-white rounded-full shadow-md transform transition ${
                        preferences.receive_enabled ? "translate-x-5" : ""
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => handleToggle("send_enabled")}
                    className={`w-11 h-6 flex items-center rounded-full p-1 transition cursor-pointer ${
                      preferences.send_enabled
                        ? "bg-indigo-600"
                        : "bg-gray-300 dark:bg-gray-600"
                    }`}
                  >
                    <div
                      className={`w-4 h-4 bg-white rounded-full shadow-md transform transition ${
                        preferences.send_enabled ? "translate-x-5" : ""
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => handleToggle("deposit_enabled")}
                    className={`w-11 h-6 flex items-center rounded-full p-1 transition cursor-pointer ${
                      preferences.deposit_enabled
                        ? "bg-indigo-600"
                        : "bg-gray-300 dark:bg-gray-600"
                    }`}
                  >
                    <div
                      className={`w-4 h-4 bg-white rounded-full shadow-md transform transition ${
                        preferences.deposit_enabled ? "translate-x-5" : ""
                      }`}
                    />
                  </button>
                </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 p-6">
            ...
            <a
              ...
              className="w-full px-4 py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors inline-block text-center"
            >
              Contact Support
            </a>
          </div>
